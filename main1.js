...
let leclub = document.getElementsByName("club");
...
// let regexemail =  /\w+@(gmail|hotmail|yahoo|ofppt).(com|org|net|ma)/g;
...
if(leclub[0].selectedOptions.length === 0 ){
    document.getElementById("erorrclub").innerHTML="obligatoir de choisir";
}else if(leclub[0].selectedOptions.length > 3) {
